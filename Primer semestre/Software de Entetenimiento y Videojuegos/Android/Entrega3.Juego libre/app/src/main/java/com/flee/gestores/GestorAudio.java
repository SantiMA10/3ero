...
/**
 * Created by santiagomartin on 12/12/15.
 */
public class GestorAudio implements MediaPlayer.OnPreparedListener{

    public static final int SONIDO_POWER_UP = 4;
    public static final int SONIDO_JUGADOR_MUERE = 2;
    public static final int SONIDO_ITEM = 1;
    ...
    public void reproducirMusicaAmbiente() {
        ...
        try{
            ...
            if(!sonidoAmbiente.isPlaying()) {
                ...
                sonidoAmbiente.setVolume(0.5F,0.5F);
